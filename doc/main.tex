...
\nt{$n$ is the number of lattice sites and $t$ is the hopping parameter. The key to ensure periodic boundary conditions is touse modulo arithmetic to connect the first and last lattice sites.}
